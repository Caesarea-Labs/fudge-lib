...
export function recordForEach<V, Rec extends Record<keyof Rec, V>, K extends keyof Rec>(record: Record<K, V>,
                                                                                        action: (key: K, value: V) => void): void {
...
export function recordSome<V, Rec extends Record<keyof Rec, V>, K extends keyof Rec>(record: Record<K, V>,
                                                                                     condition: (key: K, value: V) => boolean): boolean {
    for (const key in record) {
        const value = record[key]
...
export function recordAll<V, Rec extends Record<keyof Rec, V>, K extends keyof Rec>(record: Record<K, V>,
                                                                                    condition: (key: K, value: V) => boolean): boolean {
    for (const key in record) {
        const value = record[key]
...
export function recordNone<V, Rec extends Record<keyof Rec, V>, K extends keyof Rec>(record: Record<K, V>,
                                                                                     condition: (key: K, value: V) => boolean): boolean {
